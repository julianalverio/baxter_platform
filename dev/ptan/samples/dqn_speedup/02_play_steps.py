...
if __name__ == "__main__":
    ...
    # normal -- pick random action or the most likely, depending on epsilon
    selector = ptan.actions.EpsilonGreedyActionSelector(epsilon=params['epsilon_start'])
    #this just determines epsilon
    epsilon_tracker = common.EpsilonTracker(selector, params)
    #preprocess, run states through NN, uses selector to select action
