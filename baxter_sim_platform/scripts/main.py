...
def main():
  ...
  position2 = {'left_w0': 0.713473354262754, 'left_w1': 1.014095801262804, 'left_w2': -0.7107767620135959, 'left_e0': -0.598464939148772, 'left_e1': 0.9698857738523418, 'left_s0': -0.8576164362879198, 'left_s1': -0.2443509381144592}

  joints = manager.robot_controller._left_limb.joint_names()

  trajectory = [([position1[joint] for joint in joints], 5), ([position2[joint] for joint in joints], 5)]
